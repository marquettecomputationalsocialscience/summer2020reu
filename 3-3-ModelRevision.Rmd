...
rownames(highrelated) = c("A. Overall risk", "B. Victimization of other children (2)", "C. Mental/physical/emotional impairment (2)", "D. Substance abuse (2)", "E. History of domestic violence (2)", "F. Parenting skills/knowledge (1)", "G. Parenting skills/knowledge (2)", "H. Nurturance (1)","I. Nurturance (2)","J. Recognition of problem (1)", "K. Recognition of problem (2)","L. Protection of child (2)", "M. Cooperation (1)","N. Cooperation (2)")
colnames(highrelated) = c("A", "B", "C", "D", "E", "F", "G", "H","I","J", "K","L", "M","N")

corrplot(highrelated, method="shade", type="upper", tl.col = "black", title="Correlation of Subjective Caretaker Qualification Variables", tl.pos = "lt", tl.offset=1,  tl.srt = 0)
```
